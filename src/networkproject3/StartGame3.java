 ...
 * @author Njood
 */
public class StartGame3 extends javax.swing.JFrame{
...
///private Server server;
 ...
 public StartGame3(String playerName,BufferedReader in, PrintWriter out) {
...
private void transitionToNextFrame() {
    ...
    SwingUtilities.invokeLater(() -> {
        this.setVisible(false);  // إخفاء الفريم الحالي
         new StartGame4(playerName,in,out).setVisible(true);  // فتح الفريم التالي
    ...
    private void initComponents() {
        ...
        jButton1.setText("United kingdom");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/p2.jpg"))); // NOI18N
 ...
 private void updateScoreArea(String scores) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StartGame3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
