 ...
 * @author Njood
 */
public class StartGame4 extends javax.swing.JFrame{
...
private Server server;
 ...
 public StartGame4(String playerName,BufferedReader in, PrintWriter out) {
...
private void transitionToNextFrame() {
    ...
    SwingUtilities.invokeLater(() -> {
        this.setVisible(false);  // إخفاء الفريم الحالي
        new Q2(in,out).setVisible(true);  // فتح الفريم التالي
        this.dispose();  // تحرير الموارد بعد عرض الفريم الجديد
    });
}
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/p4.jpg"))); // NOI18N
 ...
 private void updateScoreArea(String scores) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StartGame4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
